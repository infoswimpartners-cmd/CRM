...
export const SEED_KEYWORDS: KeywordItem[] = [
    ...
    { id: 2, keyword: 'スイミング 進級の 早い子', area_category: 'tokyo_23', target_category: 'junior', current_rank: 2, previous_rank: 2, target_url: 'https://swim-partners.com/zUHb45xV/swimming_tips_up', competitor_top_url: '' },
    { id: 3, keyword: 'スイミング 上達する子', area_category: 'tokyo_23', target_category: 'junior', current_rank: 3, previous_rank: 4, target_url: 'https://swim-partners.com/zUHb45xV/swimming_tips_up', competitor_top_url: '' },
    { id: 4, keyword: 'スイミング センスのある子', area_category: 'tokyo_23', target_category: 'junior', current_rank: 6, previous_rank: 7, target_url: 'https://swim-partners.com/zUHb45xV/swimming_tips_up', competitor_top_url: '' },
...
export const SEED_ACTION_RECOMMENDATIONS: ActionRecommendationItem[] = [
    {
        ...
        priority: 'high',
        category: 'seo',
        title: '【SEO 1位狙撃】「スイミング 進級の 早い子」を2位から1位へ押し上げ',
        issue_description: '現在GSC実測2.1位（Imp: 34, Clicks: 6）。1位サイトとの差は「進級テスト合格チェックリスト」の図解とFAQの網羅性です。',
        action_directive: '対象ページ（/zUHb45xV/swimming_tips_up）に「学年別・級別の進級の壁と克服チェックリスト」を追加し、FAQ構造化データを拡充してください。',
    ...
    },
    {
        ...
        priority: 'high',
        category: 'geo',
        title: '【GEO】AI頻出引用メディア「コドモブースター」に掲載申請',
        issue_description: 'PerplexityおよびChatGPTが子供向け水泳の回答生成時に最頻出で引用している「コドモブースター」に、大手競合のみ掲載され自社が未掲載です。',
        action_directive: 'コドモブースター（kodomo-booster.com/categories/swimming）の編集部へ、スイムパートナーズの出張レッスン情報提供と掲載申請を行ってください。',
    ...
    },
    {
        ...
        priority: 'medium',
        category: 'content',
        title: '【コンテンツ】「50代 水泳 初心者」流入急増に伴う大人の泳ぎ直しCVR強化',
        issue_description: 'GSC実測で「50代 水泳 初心者」「40代 水泳」「水泳 始めたい 大人」からの表示・クリックが増加しています。',
        action_directive: '大人専用ページ（/zUHb45xV/adult-private-swimming）に「50代からの体力に合わせた個別水泳プラン」と「体験受講者の声」を最上部に追記してください。',
        action_link: '/admin/geo-seo?tab=seo',
        is_resolved: false
    }
];
