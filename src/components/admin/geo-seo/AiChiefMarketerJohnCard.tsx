...
export function AiChiefMarketerJohnCard({
    ...
    return (
        <>
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-zinc-900 via-zinc-900 to-zinc-950 text-white p-4 sm:p-7 md:p-9 border border-amber-500/30 shadow-[0_15px_40px_rgba(245,158,11,0.08)] transition-all">
                {/* アンビエント発光 */}
                ...
                <div className="relative z-10 space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-800 pb-5">
                        <div className="flex items-center gap-3 sm:gap-3.5">
                            <div className="relative flex-shrink-0">
                                <div className="w-11 sm:w-13 h-11 sm:h-13 rounded-2xl bg-gradient-to-tr from-amber-500 via-amber-400 to-amber-200 p-0.5 shadow-[0_0_20px_rgba(245,158,11,0.25)]">
                        ...
                        <div className="w-full sm:w-auto flex items-center justify-between sm:justify-end gap-2.5">
                            <button
                                ...
                                className="flex-1 sm:flex-none px-4 py-2.5 rounded-xl bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-zinc-950 text-xs font-bold transition-all shadow-[0_0_20px_rgba(245,158,11,0.25)] flex items-center justify-center gap-2"
                            >
                            ...
                            <button
                                ...
                                className="p-2.5 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-400 hover:text-zinc-200 border border-zinc-700 transition-colors flex-shrink-0"
                    ...
                    {isExpanded && (
                        <div className="space-y-5 animate-in fade-in duration-200">
                            ...
                            {/* ワンクリック相談チップ群 */}
                            <div className="pt-2 border-t border-zinc-800/60 flex flex-wrap items-center gap-1.5 sm:gap-2">
                                <span className="text-[11px] font-mono text-zinc-400 flex items-center gap-1 w-full sm:w-auto">
                                ...
                                {[
                                    ...
                                    <button
                                        ...
                                        className="px-2.5 sm:px-3 py-1.5 rounded-lg bg-zinc-800/80 hover:bg-zinc-700 text-zinc-300 text-[11px] sm:text-xs font-medium border border-zinc-700/80 hover:border-amber-500/50 transition-all shadow-sm"
                                    >
                                        {chip.label}
                                    </button>
                                ))}
